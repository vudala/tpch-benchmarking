...
ALTER TABLE LINEITEM
ADD CONSTRAINT LINEITEM_FK3 FOREIGN KEY (L_PARTKEY) references PART(P_PARTKEY);

ALTER TABLE LINEITEM
ADD CONSTRAINT LINEITEM_FK4 FOREIGN KEY (L_SUPPKEY) references SUPPLIER(S_SUPPKEY);
